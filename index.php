...
<body>
    ...
    <div class="utility-content hide">
        <div class="reveal pop-up-window small" id="pop-up-window-1" data-reveal>
        ...
        <div class="doubles-menu">
            <h1>Word is already in Database!</h1>
            <article class="card small-8" data-id-word="" data-importance-word="">
                <div class="image">
                    <div class="image-container"></div>
                    <div class="card-container word-container medium-12">
                        <h2 class="word">der Tisch</h2>
                        <h5 class="word-forms">Tische</h5>
                        <h5 class="add-word-params"></h5>
                    </div>
                </div>
                <div class="card-content">
                    <div class="card-container">
                        <h3 class="translate">Стол</h3>
                    </div>
                </div>
            </article>
            <a class="button success add_without_test small-10 small-offset-1">Все равно добавить</a>
            <a class="button info small-10 small-offset-1 addValue">Добавить доп. значение</a>
            <a class="button alert small-10 small-offset-1 cancel">Отмена</a>
        </div>
    </div>
